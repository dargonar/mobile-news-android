...
// $Id: XmlParser.java,v 1.19 2000/02/26 04:30:20 mojo Exp $
 ...
 * @version $Date: 2000/02/26 04:30:20 $
 * @see SAXDriver
 */
...
loop:
	...
	if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
	    enuma = dataBufferToString ();
	}

	// Read the default value.
	requireWhitespace ();
	parseDefault (elementName, name, type, enuma);
    }
	...
	if (tryRead ('#')) {
	    ...
	    value = readLiteral (flags);
	setAttribute (elementName, name, type, enuma, value, valueType);
    }
