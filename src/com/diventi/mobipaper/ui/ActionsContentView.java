...
public class ActionsContentView extends ViewGroup {
  ...
  public ActionsContentView(Context context, AttributeSet attrs, int defStyle) {
    ...
    addView(viewActionsContainer, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
    ...
    addView(viewContentContainer, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
  }
